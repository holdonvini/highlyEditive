    ...
    <div className="text-white ">
      <div className="grid grid-cols-1 lg:grid-cols-2 min-h-[400px]">
        <div className="col-span-1 p-4 lg:p-6 lg:border-r lg:border-zinc-800 shrink-0 grid place-items-center">
          <div className="flex flex-col gap-4">
            <h3 className="text-2xl font-serif">
              {PRICING.monthly.complex.title}
            </h3>

            {PRICING.monthly.complex.description.length > 0 && (
              <div className="flex flex-col gap-3">
                {PRICING.monthly.complex.description.map((description) => (
        ...
        <div className="col-span-1 shrink-0">
          ...
          >
            {PRICING.monthly.complex.options.map((option) => {
              return (
                <label
                  className={cn(
